...
function designCaruosel() {
  $('.caro-thumb').hover(function(){
    $(this).parent().parent.siblings(".sites-box-frame").css('background-image', $(this).data('pic-big'));
  }, function(){
    // off > revert the color
    $('.sites-box-frame').css('background-color', 'red');
  });
